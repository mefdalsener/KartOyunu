...
namespace KartOyunu
{
    public partial class BitebilenOyun : Form
    {
        ...
        public List<string> lostCards;
        public int currentCard;

        Boolean cardSwitch = false;
        public BitebilenOyun()
        {
            InitializeComponent();
        }

        private void BitebilenOyun_Load(object sender, EventArgs e)
        {
            PlayCard();
            visible_table();
